...
namespace IDAdmin
{
    public partial class Statistic_TopChanellingRecharge : Lib.UI.BasePage
    {
        protected int _page;
        ...
        public Statistic_TopChanellingRecharge()
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    _community = cmbCommunity.SelectedValue;
        ...
        private void ViewSumary()
        {
            try
            {
                string linkFormat = "Statistic_TopChanellingRecharge.aspx?page={0}&fromdate={1:dd/MM/yyyy}&todate={2:dd/MM/yyyy}&server={3}&account={4}&community={5}";
                ...
                (
                    ...
                    {   
                        ...
                        UIHelpers.CreateTableCell("Tài khoản nạp tiền",Unit.Percentage(30),HorizontalAlign.Left,"cellHeader"),
                        UIHelpers.CreateTableCell("Định danh bên đối tác",Unit.Percentage(20),HorizontalAlign.Left,"cellHeader"),                        
                        ...
                        UIHelpers.CreateTableCell("",Unit.Percentage(25),HorizontalAlign.Left, "cellHeader")
                    }
                );
                table.Rows.Add(rowHeader);

                using (DataTable dt = WebDB.Statistic_TopChanellingRecharge(_fromDate, _toDate, _server, _community, _account, _page, 50))
                {
                ...
                this.linkPrev.NavigateUrl = string.Format(linkFormat, _page > 0 ? _page - 1 : 1, _fromDate, _toDate, _server, _account, _community);
                this.linkNext.NavigateUrl = string.Format(linkFormat, _page + 1, _fromDate, _toDate, _server, _account, _community);
            }
            catch (Exception ex)
            {
